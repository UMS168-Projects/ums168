...
<div class="d-flex justify-content-between align-items-center mb-3">
  <h4 class="fw-bold mb-0">បញ្ចូល កម្រិត</h4>
  <a href="index.php">
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="mb-3">
                ...
                <input type="text" required name="TxtDegreeNameKH" id="TxtDegreeNameKH" class="form-control" />
              </div>
            </div>
            <div class="col-sm-6">
              <div class="mb-3">
                <label class="form-label" for="basic-default-fullname">ឈ្មោះអង់គ្លេស</label>
                <input type="text" required name="TxtDegreeNameEN" id="TxtDegreeNameEN" class="form-control" />
              </div>
            </div>
            <div class="col-sm-6">
              <div class="mb-3">
