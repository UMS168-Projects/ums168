                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="TxtBatchNameKH" id="TxtBatchNameKH" class="form-control"
                                    value="<?php echo isset($row['BatchNameKH']) ? $row['BatchNameKH'] : ''; ?>" placeholder="Example" />
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label">NameEN</label>
                                <input type="text" name="TxtBatchNameEN" id="TxtBatchNameEN" class="form-control"
                                    value="<?php echo isset($row['BatchNameEN']) ? $row['BatchNameEN'] : ''; ?>" placeholder="Example" />
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="mb-3">
