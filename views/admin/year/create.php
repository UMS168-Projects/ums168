          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="mb-3">
                ...
                <input type="text" required name="TxtYearNameKH" id="TxtYearNameKH" class="form-control" />
              </div>
            </div>
            <div class="col-sm-6">
              <div class="mb-3">
                <label class="form-label" for="basic-default-fullname">ឈ្មោះអង់គ្លេស</label>
                <input type="text" required name="TxtYearNameEN" id="TxtYearNameEN" class="form-control" />
              </div>
            </div>
            <div class="col-sm-6">
              <div class="mb-3">
